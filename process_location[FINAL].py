...
def timelimiter(low, high, d_array):
...
def findTimes(d_array, timeRange, threshold):
    lower = timeRange[0]
    upper = timeRange[1]
...
imu_mean_std_trained_data = [(0.3035481770833333, 2.437252790190614), (-0.7532784598214286, 1.0408444663530396),
                             (-0.185595703125, 0.36990816314037245), (None, None), (-2.4500558035714284, 2.608362907138707),
                             (None, None), (-1.8760986328125, 0.964585829636136), (-1.2797154017857142, 0.556574333915539),
    ...
    for x in range(0,len(aud_guess)):
        ...
        if aud_guess[x] is None and imu_guess[x] is None:
            ...
            if aud_guess[x][2]==3:
                ...
                FinalYGuess=.8*aud_guess[x][1]+.8*imu_guess[x][1]
